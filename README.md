...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-acttzws.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-acttzws.containers.anotherwebservice.com/
...
```
git clone git@github.com:shshsh1385/container-acttzws.git
cd container-acttzws
```
...
```
docker attach container-acttzws
```
